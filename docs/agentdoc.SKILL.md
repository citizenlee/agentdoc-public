---
name: agentdoc
description: Work with hosted AgentDoc documents over HTTP. Use when creating, reading, editing, or reviewing shared docs with the agent API or bridge routes.
---

# AgentDoc

AgentDoc is a collaborative document editor with an agent HTTP bridge. It provides state, marks, edits, presence, and event APIs.
