...
const REQUIRED_HEADER_VERSION = 'x-agentdoc-client-version';
const REQUIRED_HEADER_BUILD = 'x-agentdoc-client-build';
const REQUIRED_HEADER_PROTOCOL = 'x-agentdoc-client-protocol';

const MIN_CLIENT_VERSION = '0.30.0';
const MIN_CLIENT_PROTOCOL = 3;
const SUPPORTED_PROTOCOLS = [3];
const UPGRADE_URL = 'https://agentdoc.up.railway.app';
...
function buildUpgradePayload(reason: string, details?: Record<string, unknown>): Record<string, unknown> {
  return {
    ...
    message: `Please upgrade your Agentdoc client to ${MIN_CLIENT_VERSION} or newer.`,
