...
export interface AgentdocDocumentPaths {
  create: string;
  document: string;
  title: string;
  state: string;
...
export interface AgentdocRouteOptions {
  origin?: string;
...
export function buildAgentdocDocumentPaths(slug: string, origin?: string): AgentdocDocumentPaths {
...
export function buildAgentdocLinks(
  slug: string,
  {
    origin,
  ...
  }: AgentdocRouteOptions = {},
): Record<string, unknown> {
  const paths = buildAgentdocDocumentPaths(slug, origin);
...
export function buildAgentdocAgentDescriptor(
  slug: string,
  {
    origin,
    includeMutationRoutes = true,
  ...
  const agent: Record<string, unknown> = {
    what: 'agentdocs - ai-native human collab doc editor',
    docs: paths.docs,
