...
This contract defines the public AgentDoc SDK flow for creating and operating on shared documents over HTTP.
...
```json
{
  ...
  "url": "/d/abc123xy",
  "shareUrl": "https://your-agentdoc.example/d/abc123xy",
  "tokenPath": "/d/abc123xy?token=...",
  "tokenUrl": "https://your-agentdoc.example/d/abc123xy?token=...",
  "ownerSecret": "8b5f...owner secret...",
  "accessToken": "4d53...link token...",
  "accessRole": "commenter",
  "active": true,
  "shareState": "ACTIVE",
  "snapshotUrl": "https://your-agentdoc.example/snapshots/abc123xy.html",
...
`AGENTDOC_SHARE_MARKDOWN_AUTH_MODE` controls direct-share auth:

- `none`: open route, good for local/dev
- `api_key`: require `AGENTDOC_SHARE_MARKDOWN_API_KEY`
- `auto`: resolve to `none` by default in AgentDoc SDK

`/api/documents` is governed separately by `AGENTDOC_LEGACY_CREATE_MODE`:
