/**
 * Type definitions for AgentDoc Agent
 */
...
export type AgentTaskType =
  | 'comment-response'  // Responding to a comment with @agentdoc mention
  | 'document-edit'     // Direct document editing request
  | 'inline-mention'    // @agentdoc mentioned inline in document body
...
export interface AgentTrigger {
  /** The @agentdoc mention text with surrounding context */
  mentionText: string;
