...
export const COMMENT_UI_MODE_STORAGE_KEY = 'agentdoc.commentUi';
export const COMMENT_UI_MODE_WIDTH_FALLBACK_PX = 900;

type AgentdocConfigWindow = Window & {
  __AGENTDOC_CONFIG__?: {
...
function getRuntimeDefaultMode(): CommentUiMode | null {
  if (typeof window === 'undefined') return null;
  return normalizeCommentUiMode((window as AgentdocConfigWindow).__AGENTDOC_CONFIG__?.commentUiDefaultMode);
}
