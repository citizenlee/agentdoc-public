...
async function run(): Promise<void> {
  ...
  (globalThis as { window: Record<string, unknown> }).window = {
    location: new URL('https://agentdoc-web-staging.up.railway.app/d/test-doc?token=share-token'),
    __AGENTDOC_CONFIG__: {
      agentdocClientVersion: '0.31.2',
      agentdocClientBuild: 'test',
      agentdocClientProtocol: '3',
    },
  };
