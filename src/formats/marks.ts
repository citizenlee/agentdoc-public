 ...
 * Palette: Soft Focus - designed for the Agentdoc editor surface
 */
...
const MARKS_START_MARKER = '<!-- AGENTDOC';
const MARKS_END_MARKER = '-->';
const MARKS_CLOSE_MARKER = '<!-- AGENTDOC:END -->';
// Accept both new AGENTDOC and legacy PROOF markers for backward compat with stored documents
const MARKS_REGEX = /\n?<!-- (?:AGENTDOC|PROOF)\n([\s\S]*?)\n-->\s*(?:<!-- (?:AGENTDOC|PROOF):END -->\s*)?/g;
