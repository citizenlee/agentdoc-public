...
function buildPrompt(docUrl: string): string {
  return `Here's my Agentdoc document: ${docUrl}

Agentdoc is a collaborative writing editor that tracks who wrote what (human vs AI). You can read the doc, suggest edits, leave comments, and rewrite content via its HTTP API. API docs: http://localhost:4000/agent-docs
