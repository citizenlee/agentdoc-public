...
function createDialogElement(): HTMLElement {
  ...
  dialog.innerHTML = `
    <div class="agent-input-dialog-content">
      <div class="agent-input-dialog-header">
        <span class="agent-input-dialog-title">Ask Agentdoc</span>
      ...
      <div class="agent-input-dialog-body">
        ...
        <textarea
          ...
          placeholder="What would you like Agentdoc to do?"
          rows="3"
        ></textarea>
      </div>
  ...
  style.textContent = `
    ...
    .agent-input-quick-action:hover {
      background: var(--agentdoc-bg-hover, #e5e7eb);
      color: var(--agentdoc-text, #1f2937);
    }
    ...
    .agent-input-dialog-submit:hover {
      background: var(--agentdoc-primary-hover, #1d4ed8);
    }
