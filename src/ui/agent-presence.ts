...
function createPresenceElement(): HTMLElement {
  ...
  if (!document.getElementById('agent-presence-styles')) {
    ...
    style.textContent = `
      .agent-presence {
        padding: 12px 0;
        border-top: 1px solid var(--agentdoc-border, #e5e7eb);
      }
      ...
      .agent-presence-header {
        ...
        color: var(--agentdoc-text-muted, #6b7280);
        padding: 0 16px 8px;
      }
      ...
      .agent-card {
        background: var(--agentdoc-bg-secondary, #f9fafb);
      ...
      .agent-card:hover {
        ...
        border-color: var(--agentdoc-border-hover, #d1d5db);
      }

      .agent-card.following {
        border-color: var(--agentdoc-primary, #2563eb);
      ...
      .agent-following-badge {
        font-size: 10px;
        background: var(--agentdoc-primary, #2563eb);
        color: white;
        padding: 2px 6px;
        border-radius: 3px;
      }
      ...
      .agent-position {
        background: var(--agentdoc-bg-tertiary, #e5e7eb);
        padding: 2px 6px;
        border-radius: 3px;
        cursor: pointer;
      }
      ...
      .agent-position:hover {
        background: var(--agentdoc-bg-hover, #d1d5db);
      }
      ...
      .agent-action-btn.cancel-btn:hover {
        background: var(--agentdoc-error-bg, #fef2f2);
        border-color: var(--agentdoc-error, #ef4444);
        color: var(--agentdoc-error, #ef4444);
      }

      .agent-action-btn.resume-btn:hover {
        background: var(--agentdoc-success-bg, #f0fdf4);
        border-color: var(--agentdoc-success, #10b981);
        color: var(--agentdoc-success, #10b981);
      }
      ...
      @media (prefers-color-scheme: dark) {
        .agent-presence {
          --agentdoc-bg: #1f2937;
          --agentdoc-bg-secondary: #374151;
          --agentdoc-bg-tertiary: #4b5563;
          --agentdoc-bg-hover: #4b5563;
          --agentdoc-border: #4b5563;
          --agentdoc-border-hover: #6b7280;
          --agentdoc-text: #f9fafb;
          --agentdoc-text-muted: #9ca3af;
          --agentdoc-primary: #3b82f6;
          --agentdoc-success: #34d399;
          --agentdoc-warning: #fbbf24;
          --agentdoc-error: #f87171;
        }
      }
    `;
